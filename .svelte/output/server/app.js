...
var Counter_svelte = "button.svelte-x7tt1a{font-family:inherit;font-size:inherit;padding:1em 2em;color:#ff3e00;background-color:rgba(255, 62, 0, 0.1);border-radius:2em;border:2px solid #ff3e00;outline:none;width:200px;height:60px;font-variant-numeric:tabular-nums}button.svelte-x7tt1a:focus,button.svelte-x7tt1a:hover{border:3px solid #ff3e00}button.svelte-x7tt1a:active{background-color:rgba(255, 62, 0, 0.2)}";
const css$1 = {
  code: "button.svelte-x7tt1a{font-family:inherit;font-size:inherit;padding:1em 2em;color:#ff3e00;background-color:rgba(255, 62, 0, 0.1);border-radius:2em;border:2px solid #ff3e00;outline:none;width:200px;height:60px;font-variant-numeric:tabular-nums}button.svelte-x7tt1a:focus,button.svelte-x7tt1a:hover{border:3px solid #ff3e00}button.svelte-x7tt1a:active{background-color:rgba(255, 62, 0, 0.2)}",
  map: '{"version":3,"file":"Counter.svelte","sources":["Counter.svelte"],"sourcesContent":["<script>\\n\\tlet count = 0;\\n\\t\\n\\tconst increment = () => {\\n\\t\\tcount += 1;\\n\\t};\\n</script>\\n\\n<button on:click={increment}>\\n\\tClicks: {count}\\n</button>\\n\\n<style>\\n\\tbutton {\\n\\t\\tfont-family: inherit;\\n\\t\\tfont-size: inherit;\\n\\t\\tpadding: 1em 2em;\\n\\t\\tcolor: #ff3e00;\\n\\t\\tbackground-color: rgba(255, 62, 0, 0.1);\\n\\t\\tborder-radius: 2em;\\n\\t\\tborder: 2px solid #ff3e00;\\n\\t\\toutline: none;\\n\\t\\twidth: 200px;\\n\\t\\theight: 60px;\\n\\t\\tfont-variant-numeric: tabular-nums;\\n\\t}\\n\\n\\tbutton:focus,\\n\\tbutton:hover {\\n\\t\\tborder: 3px solid #ff3e00;\\n\\t}\\n\\n\\tbutton:active {\\n\\t\\tbackground-color: rgba(255, 62, 0, 0.2);\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAaC,MAAM,cAAC,CAAC,AACP,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,GAAG,CAAC,GAAG,CAChB,KAAK,CAAE,OAAO,CACd,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACvC,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CACZ,oBAAoB,CAAE,YAAY,AACnC,CAAC,AAED,oBAAM,MAAM,CACZ,oBAAM,MAAM,AAAC,CAAC,AACb,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAC1B,CAAC,AAED,oBAAM,OAAO,AAAC,CAAC,AACd,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACxC,CAAC"}'
};
const Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let count = 0;
  $$result.css.add(css$1);
  return `<button class="${"svelte-x7tt1a"}">Clicks: ${escape(count)}
</button>`;
});
var index_svelte = "main.svelte-ocp1vb{text-align:center;padding:1em;margin:0 auto}h1.svelte-ocp1vb{color:#ff3e00;text-transform:uppercase;font-size:4rem;font-weight:100;line-height:1.1;margin:4rem auto;max-width:14rem}p.svelte-ocp1vb{max-width:14rem;margin:2rem auto;line-height:1.35}@media(min-width: 480px){h1.svelte-ocp1vb{max-width:none}p.svelte-ocp1vb{max-width:none}}";
const css = {
  code: "main.svelte-ocp1vb{text-align:center;padding:1em;margin:0 auto}h1.svelte-ocp1vb{color:#ff3e00;text-transform:uppercase;font-size:4rem;font-weight:100;line-height:1.1;margin:4rem auto;max-width:14rem}p.svelte-ocp1vb{max-width:14rem;margin:2rem auto;line-height:1.35}@media(min-width: 480px){h1.svelte-ocp1vb{max-width:none}p.svelte-ocp1vb{max-width:none}}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script>\\n\\timport Counter from '$lib/Counter.svelte';\\n</script>\\n\\n<svelte:head>\\n\\t<title>Hello world!</title>\\n</svelte:head>\\n\\n<main>\\n\\t<h1>Hello world!</h1>\\n\\n\\t<Counter />\\n\\n\\t<p><a href=\\"/about\\">About</a></p>\\n</main>\\n\\n<style>\\n\\tmain {\\n\\t\\ttext-align: center;\\n\\t\\tpadding: 1em;\\n\\t\\tmargin: 0 auto;\\n\\t}\\n\\n\\th1 {\\n\\t\\tcolor: #ff3e00;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tfont-size: 4rem;\\n\\t\\tfont-weight: 100;\\n\\t\\tline-height: 1.1;\\n\\t\\tmargin: 4rem auto;\\n\\t\\tmax-width: 14rem;\\n\\t}\\n\\n\\tp {\\n\\t\\tmax-width: 14rem;\\n\\t\\tmargin: 2rem auto;\\n\\t\\tline-height: 1.35;\\n\\t}\\n\\n\\t@media (min-width: 480px) {\\n\\t\\th1 {\\n\\t\\t\\tmax-width: none;\\n\\t\\t}\\n\\n\\t\\tp {\\n\\t\\t\\tmax-width: none;\\n\\t\\t}\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAiBC,IAAI,cAAC,CAAC,AACL,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,AACf,CAAC,AAED,EAAE,cAAC,CAAC,AACH,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,SAAS,CACzB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,SAAS,CAAE,KAAK,AACjB,CAAC,AAED,CAAC,cAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,WAAW,CAAE,IAAI,AAClB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,EAAE,cAAC,CAAC,AACH,SAAS,CAAE,IAAI,AAChB,CAAC,AAED,CAAC,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,AAChB,CAAC,AACF,CAAC"}`
};
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Hello world!</title>`, ""}`, ""}

<main class="${"svelte-ocp1vb"}"><h1 class="${"svelte-ocp1vb"}">Hello world!</h1>

	${validate_component(Counter, "Counter").$$render($$result, {}, {}, {})}

	<p class="${"svelte-ocp1vb"}"><a href="${"/about"}">About</a></p>
</main>`;
});
